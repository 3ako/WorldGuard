...
public class RegionProtectionListener extends AbstractListener {
    ...
    public void onSpawnEntity(SpawnEntityEvent event) {
        ...
        /* XP drops */
            ...
            what = "использовать затяжные зелья";
